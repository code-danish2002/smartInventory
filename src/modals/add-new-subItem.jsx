...
const AddSubItem = ({ subItemName, operation, defaultValues, onCancel, AfterAction }) => {
    ...
    useEffect(() => {
        ...
        if (subItemName === 'Stores' || subItemName === 'Users') {
            api.get('/api/pops/simple', { params: { page: 1, limit: 0 } }).then((response) => {
    ...
    const handleAsyncSelectChange = (selectedOption, element) => {
        ...
        setSubItemDetails({ ...subItemDetails, [element.name]: selectedOption?.value }); // Removed trailing (option)
        setOptions((prev) => ({
            ...prev,
                ...
                <div key={index} className="flex flex-col gap-2 mb-4">
                    ...
                    {element.element === 'input' ? (
                        ...
                        <AsyncSelect
                            ...
                            placeholder={element.placeholder || 'Enter Name'}
