      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="hidden md:block mb-8">
          <div className="flex justify-between relative">
            ...
            {/* Third row - Site and Live/OEM Spare */}
            <div className="relative z-10 flex flex-col items-center">
              <div className="flex flex-col items-center">
                <div className={`
                  flex items-center justify-center w-16 h-16 rounded-full mb-2
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Inspection → Store → Site → Live/OEM Spare</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Inspection → Direct to → Site → Live/OEM Spare</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200 mt-4">
          ...
          <ul className="list-disc list-inside">
            ...
            <figure className="my-4 text-center">
              <img
                src={inspectionApproveDialog}
                alt="add certificate table"
                className="mx-auto rounded-md shadow-md"
              />
              <figcaption className="mt-2 text-sm text-gray-600">
                Image-8
          ...
          <ul className="list-disc list-inside">
            ...
            <figure className="my-4 text-center">
              <img
                src={lineItemDispatchDialog}
                alt="line item dispatch"
                className="mx-auto rounded-md shadow-md"
              />
              <figcaption className="mt-2 text-sm text-gray-600">
                Image-11
          ...
          <strong>You as an OEM Spare Incharge</strong>
          <ul className="list-disc list-inside">
