...
const CardTable = ({ phaseIds, onBackToDashboard, initialData }) => {
    ...
    return (
        <div className="flex flex-col h-full overflow-hidden p-4 sm:p-6 lg:p-8 bg-slate-100 transition-all duration-300">
            ...
            <div className="flex-1 bg-white shadow-xl rounded-lg overflow-hidden border border-gray-200 min-h-0">
                <MyTable
                    title={title}
                    loading={loading}
                    data={data}
