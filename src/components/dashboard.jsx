...
const Dashboard = ({ apiData, loading }) => {
    ...
    const icons = {
        ...
        'Inventory': <MdOutlineInventory className="w-12 h-12 text-sky-500 group-hover:text-sky-600" />
    }
    ...
    const countGradients = {
        ...
        'Inventory': "from-sky-400 via-sky-200 to-sky-600"
    };

    const information = {
        0: "POs created by you",
        1: "Add PDF to POs",
        2: "POs that need correction",
        3: "POs sent to you for inspection",
        4: "POs sent to you for inspection",
        5: "Items that have been rejected at the store",
        6: "Items that have been rejected at the site",
        7: "Items that are at the store",
        8: "Items that are at the store",
        9: "Items that are at the Inventory",
        10: "Items that are at the site",
        11: "Items that are at the site",
        12: "Items that are at the Inventory",
            ...
            {loading ? (
                ...
                >
                    {[
                        ...
                        ...Object.keys(apiData).filter(k => k !== "0" && k !== "13" && k !== "2" && k !== "5" && k !== "6"),
                        "2",
                        "5",
                        "6",
                    ].map(id => (
