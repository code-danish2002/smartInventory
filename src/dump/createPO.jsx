...
import LineItemForm from '../components/create-po/lineItemForm.jsx';
  ...
  const handleConfirmSubmit = async (e, lineItems, esign) => {
    ...
    try {
      ...
      if (task === 'Create Inspection') {
        ...
        //handleSetCurrentRender('Dashboard');  or whatever view shows the PO list
        navigate('/'); // or navigate to the specific grid view that triggered this
      }
