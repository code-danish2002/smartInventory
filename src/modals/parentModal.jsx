            ...
            <div className={`bg-white shadow-2xl overflow-hidden flex flex-col ${containerClass}`}>
                <div className="bg-gray-50 gap-4 px-6 py-4 flex justify-between items-center">
                    <h2 className="text-xl font-semibold text-gray-800">
                        ...
                        {type === 'send to location' && `Send to Location`}
                        {type === 'help&support' && `Help & Support`}
                    </h2>
                ...
                <div className="overflow-auto p-4 flex-1">
                    ...
                    {type === 'send to location' && (
                        <LiveOrSpare po_item_details_id={data?.params?.po_item_details_id} onClose={onClose} onAction={onAction} />
                    )}
                    {type === 'help&support' && (
                        <HelpAndSupport />
                    )}
