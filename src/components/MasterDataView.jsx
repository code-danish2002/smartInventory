...
const MasterDataView = () => {
    ...
    const { data: queryResponse, isLoading, error, isFetching, refetch } = useQuery({
    ...
    return (
        <div className="flex flex-col gap-4 h-full overflow-hidden bg-white dark:bg-slate-900/50 p-2 rounded-xl">
            <div className="flex items-center justify-between gap-2 flex-shrink-0 mb-4">
                <div className="relative w-full md:w-1/2">
                    ...
                    <input
                        ...
                        className="w-full border border-gray-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-gray-900 dark:text-slate-100 placeholder-gray-400 dark:placeholder-slate-500 rounded-lg pr-4 py-2 pl-10 max-w-xs focus:outline-none focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out text-sm"
