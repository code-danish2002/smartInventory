// PurchaseOrderReportsDashboard.jsx
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    <thead>
                        <tr className="bg-gray-100">
                            <th className="px-6 py-3 text-left text-xs font-bold text-gray-600 uppercase tracking-wider rounded-tl-xl">PO Number</th>
                            <th className="px-6 py-3 text-left text-xs font-bold text-gray-600 uppercase tracking-wider">PO ID</th>
                            <th className="px-6 py-3 text-left text-xs font-bold text-gray-600 uppercase tracking-wider">Issue Date</th>
                            <th className="px-6 py-3 text-left text-xs font-bold text-gray-600 uppercase tracking-wider">Created Date</th>
                            <th className="px-6 py-3 text-left text-xs font-bold text-gray-600 uppercase tracking-wider">Available Phases</th>
                            <th className="px-6 py-3 text-left text-xs font-bold text-gray-600 uppercase tracking-wider rounded-tr-xl">Action</th>
                        </tr>
                    </thead>
...
const TableRow = ({ po }) => {
    ...
    return (
        <tr className="hover:bg-gray-50 transition duration-150 ease-in-out">
            ...
            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{po.po_id}</td>
        ...
        <div className="p-4 sm:p-4">
            <div className="max-w-7xl mx-auto">
                ...
                <header className="mb-8">
                    <h3 className="font-bold text-gray-500 border-b-2 pb-2 mb-2">Overview of Purchase Order documents.</h3>
                </header>

                {/* Main Content */}
                <div className="bg-transparent shadow-xl rounded-xl overflow-hidden">
                    <div className="p-4 sm:p-6 bg-gray-50 border-b rounded-xl">
