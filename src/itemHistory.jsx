...
const ItemHistory = ({ data = [], maxWidth = "max-w-4xl" }) => {
  ...
  const phaseConfig = {
    ...
    "PO Initiated": { color: "border-cyan-500 text-cyan-500", icon: FaWpforms, title: "Purchase Order" },
    "Inspection": { color: "border-blue-500 text-blue-500", icon: FaClipboardCheck, title: "Quality Inspection" },
    ...
    "PO Approved": { color: "border-blue-500 text-blue-500", icon: FaCheckCircle, title: "Approved" },
    "Store": { color: "border-purple-500 text-purple-500", icon: FaWarehouse, title: "Store Management" },
    "On Site": { color: "border-green-500 text-green-500", icon: FaMapMarkerAlt, title: "Site Deployment" },
    "OEM Spare": { color: "border-yellow-500 text-yellow-500", icon: FaTools, title: "OEM Spare" },
  ...
  const statusDetails = {
    ...
    "Inspection Report Submitted": { color: "bg-teal-100 text-teal-800", icon: FaCloudUploadAlt },
                  ...
                  {items.map((item, itemIdx) => {
                    ...
                    return (
                      <div
                        ...
                        className={`relative p-4 rounded-xl transition-all duration-150 ${
                            isEven ? "bg-gray-50 border-r-4 border-dashed border-gray-200 hover:bg-gray-100" : "bg-white border-l-4 border-dashed border-gray-200 hover:bg-gray-50"
                        }`}
                      >
