...
const needAcceptance = (thisStatus) => {
    return thisStatus === "Pending Approval" ||
        thisStatus === "Receive Pending at Store" ||
        thisStatus === "Receive Pending at Site";
}
...
export const ItemsAcceptance = ({ isOpen, onCancel, po_id, onSubmit, phase }) => {
    ...
    const thisPhase = phase === 'At Store' ? 'Store' : phase === 'On Site' ? 'Site' : 'Inspection';
